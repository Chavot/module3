...
@section('content')
            <div style="height: 90vh" class="text-center text-white pt-60 bg-blue">
                ...
                <a style="background: #FF3C38; border-color: #FF3C38 "class="border-2 inline-block px-6 py-2.5 m-6 text-white font-medium leading-tight
                ...
                <a style="border-color: #242F40"class="border-2 inline-block px-8 py-2.5 m-6 text-darkblue font-medium leading-tight
